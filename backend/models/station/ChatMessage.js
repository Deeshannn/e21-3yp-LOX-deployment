...
const buildStationChatMessageModel = (connection) => connection.models.ChatMessage || connection.model("ChatMessage", chatMessageSchema)

module.exports = { chatMessageSchema, buildStationChatMessageModel }